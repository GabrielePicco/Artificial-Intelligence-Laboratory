...
;;* DEFAULTS      
  ...
  (attribute (name n-day) (value 3) (is-default TRUE) (certainty 50.0))
...
(deffacts LOCATIONS::location-lists
  ...
  (location (name "Napoli")
            ...
            (lat 40.839981)
            (long 14.252540)
            (tourism-type enogastronomico 5.0 sportivo 4.8 balneare 4.7 religioso 4.8 culturale 3.9)
  )
  (location (name "Positano")
            (region campania)
            (lat 40.628052)
            (long 14.484981)
            (tourism-type enogastronomico 4.7 balneare 5.0)
  )
  ...
  (location (name "Capri")
            ...
            (lat 40.550911)
            (long 14.242930)
            (tourism-type enogastronomico 5.0 balneare 5.0 naturalistico 4.8)
  )
